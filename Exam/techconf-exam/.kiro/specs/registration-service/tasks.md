...
- [ ] 1. Project setup, domain exceptions, and RegistrationRepository interface + 3 adapters (memory, json, sqlite).
...
- [ ] 2. RegistrationService business logic (capacity checks, user/event verification, duplicate prevention).
...
- [ ] 4. Unit/Integration tests with OpenAPI contract assertions and pytest coverage >= 80%.
